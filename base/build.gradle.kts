...
bomGenerator {
    ...
    includeDependency("org.junit.jupiter", "junit-jupiter-api", "5.11.1")
    includeDependency("org.junit.jupiter", "junit-jupiter-engine", "5.11.1")
    includeDependency("org.mockito", "mockito-core", "5.14.0")
    includeDependency("org.mockito", "mockito-junit-jupiter", "5.14.0")
